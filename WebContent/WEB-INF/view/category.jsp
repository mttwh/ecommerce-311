...
<div class="product-rows">
		...
		<c:forEach var="product" items="${categoryProductList}">
			...
			<tr>
				<td><img class="product-image"
					src="img/${product.productName}.png" alt="${product.productName}">
				</td>
				...
				<td>
					<form action="addToCart" method="POST">
						<input type="hidden" name="productName"
							value="${product.productName}"> <input class="button"
							type="submit" name="addToCart" value="Add To Cart"
							onclick="return confirm('Are you sure you want to add this to your cart?')">
					</form>
				</td>
                 <td>
	...
	<div id="addToCartMessageField"></div>
	<c:if test="${addToCartMessage ==  'Added'}">
		<script>
					var message = "<span id='success-popup'>You have added an item to your cart.</span>";
					document.getElementById("addToCartMessageField").innerHTML=message;
				</script>
	</c:if>
</div>