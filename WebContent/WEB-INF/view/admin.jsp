...
<p>This is the page where store managers can add, remove, or update
	products from the site</p>
<hr>
...
<div id="login-form">
	<form action="addProduct" method="POST">
		...
		<br /> <input id="button" type="submit" name="addProductButton"
			value="Add Product">
	</form>
</div>
					...
					<div id="productButtons">
						...
						<form action="updateProduct" method="post">
							<input type="hidden" name="productToUpdate"
								value="${product.productName}"> <input type="submit"
								name="updateButton" value="Update Product"
								onclick="return confirm('Are you sure?')">
						</form>
					</div>
				</td>
