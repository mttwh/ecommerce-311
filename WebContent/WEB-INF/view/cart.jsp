...
<div id="checkout-widget">
	<form action="checkout" method="post">
		<span id="cart-balance">Balance: $${balance}</span> <input
			type="submit" value="Checkout"> <input type="hidden"
